<div class="wrap">
    <h1><?php esc_html_e( $view->args['page_title'] ); ?></h1>

<form method="post">
    <?php wp_nonce_field
<input name="option_page" value="general" type="hidden"><input name="action" value="update" type="hidden"><input id="_wpnonce" name="_wpnonce" value="7cb6b5357b" type="hidden"><input name="_wp_http_referer" value="/tagd/wp-admin/options-general.php" type="hidden">
<table class="form-table">
<tbody><tr>
<th scope="row"><label for="blogname">Site Title</label></th>
<td><input name="blogname" id="blogname" value="Imgd Sandbox" class="regular-text" type="text"></td>
</tr>
<tr>
<th scope="row"><label for="blogdescription">Tagline</label></th>
<td><input name="blogdescription" id="blogdescription" aria-describedby="tagline-description" value="Just another Dev Sites site" class="regular-text" type="text">
...
<td><input name="new_admin_email" id="new_admin_email" aria-describedby="new-admin-email-description" value="markandrewslade@gmail.com" class="regular-text ltr" type="email">
...
<p class="description" id="timezone-description">Choose a city in the same timezone as you.</p>

<p class="timezone-info">
	<span id="utc-time">Universal time (<abbr>UTC</abbr>) is <code>2016-09-17 00:51:27</code>.</span>
</p>
...
<td>
	...
	<label><input name="date_format" value="F j, Y" checked="checked" type="radio"> <span class="date-time-text format-i18n">September 17, 2016</span><code>F j, Y</code></label><br>
	<label><input name="date_format" value="Y-m-d" type="radio"> <span class="date-time-text format-i18n">2016-09-17</span><code>Y-m-d</code></label><br>
	<label><input name="date_format" value="m/d/Y" type="radio"> <span class="date-time-text format-i18n">09/17/2016</span><code>m/d/Y</code></label><br>
	<label><input name="date_format" value="d/m/Y" type="radio"> <span class="date-time-text format-i18n">17/09/2016</span><code>d/m/Y</code></label><br>
<label><input name="date_format" id="date_format_custom_radio" value="\c\u\s\t\o\m" type="radio"> <span class="date-time-text date-time-custom-text">Custom:<span class="screen-reader-text"> enter a custom date format in the following field</span></span></label><label for="date_format_custom" class="screen-reader-text">Custom date format:</label><input name="date_format_custom" id="date_format_custom" value="F j, Y" class="small-text" type="text"><span class="screen-reader-text">example: </span> <span class="example">September 17, 2016</span><span class="spinner"></span>
	</fieldset>
</td>
</tr>
<tr>
...
<td>
	...
	<label><input name="time_format" value="g:i a" checked="checked" type="radio"> <span class="date-time-text format-i18n">12:51 am</span><code>g:i a</code></label><br>
	<label><input name="time_format" value="g:i A" type="radio"> <span class="date-time-text format-i18n">12:51 AM</span><code>g:i A</code></label><br>
	<label><input name="time_format" value="H:i" type="radio"> <span class="date-time-text format-i18n">00:51</span><code>H:i</code></label><br>
<label><input name="time_format" id="time_format_custom_radio" value="\c\u\s\t\o\m" type="radio"> <span class="date-time-text date-time-custom-text">Custom:<span class="screen-reader-text"> enter a custom time format in the following field</span></span></label><label for="time_format_custom" class="screen-reader-text">Custom time format:</label><input name="time_format_custom" id="time_format_custom" value="g:i a" class="small-text" type="text"><span class="screen-reader-text">example: </span> <span class="example">12:51 am</span><span class="spinner"></span>
...
<td><select name="start_of_week" id="start_of_week">
	...
	<tr>
		<th scope="row" width="33%"><label for="WPLANG">Site Language</label></th>
		<td>
			<select name="WPLANG" id="WPLANG"><optgroup label="Installed">
<option value="" data-installed="1" lang="en">English (United States)</option>
</optgroup>
...
<option value="bo" lang="bo">བོད་སྐད</option>
